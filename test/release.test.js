...
test('версия интерфейса, ресурсов и автономного кеша согласована',async()=>{
  ...
  assert.match(index,/styles\/app\.css\?v=37/);
  assert.match(index,/src\/app\.js\?v=37/);
  assert.match(app,/sw\.js\?v=37/);
  assert.match(ui,/APP_VERSION='37'/);
  ...
  assert.match(store,/data\.js\?v=37/);
  assert.match(worker,/stack-moonvit-shell-v37/);
